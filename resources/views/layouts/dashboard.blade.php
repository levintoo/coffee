                    ...
                    <li class="cart-nav onhover-dropdown">
                        ...
                        <div class="cart-dropdown onhover-show-div">
                            ...
                            <ul class="custom-scrollbar">
                                <li>
                                    <div class="media"><img class="img-fluid b-r-5 me-3 img-50" src="{{ asset('assets/images/banner-1.jpg') }}" alt="">
                                ...
                                <li>
                                    <div class="media"><img class="img-fluid b-r-5 me-3 img-50" src="{{ asset('assets/images/product-4.png') }}" alt="">
                                        <div class="media-body">
                                ...
                                <li>
                                    <div class="media"><img class="img-fluid b-r-5 me-3 img-50" src="{{ asset('assets/images/product-6.jpg') }}" alt="">
                                        <div class="media-body">
                    ...
                    <li class="onhover-dropdown">
                        ...
                        <div class="onhover-show-div notification-dropdown">
                            ...
                            <ul class="custom-scrollbar">
                                ...
                                <li>
                                    <div class="media">
                                        <div class="notification-img bg-light-secondary"><img src="{{ asset('assets/images/avtar/teacher.png') }}" alt=""></div>
                                        <div class="media-body">
                                ...
                                <li>
                                    <div class="media">
                                        <div class="notification-img bg-light-info"><img src="{{ asset('assets/images/avtar/teenager.png') }}" alt=""></div>
                                        <div class="media-body">
                                ...
                                <li>
                                    <div class="media">
                                        <div class="notification-img bg-light-success"><img src="{{ asset('assets/images/avtar/chinese.png') }}" alt=""></div>
                                        <div class="media-body">
                ...
                <nav class="sidebar-main">
                    ...
                    <div id="sidebar-menu">
                        <ul class="sidebar-links" id="simple-bar">
                            <li class="back-btn"><a href="index-2.html"><img class="img-fluid" src="{{ asset('assets/images/logo-icon.png') }}" alt=""></a>
