                ...
                <div class="col-md-4 col-lg-4 col-xl-4 box-col-4">
                    <div class="card custom-card">
                        ...
                        <ul class="card-social">
                            ...
                            <li><a href="#" wire:click.prevent="suspendUser('{{$user->username}}')"><svg class="svg-inline--fa fa-ban" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="ban" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg=""><path fill="currentColor" d="M512 256C512 397.4 397.4 512 256 512C114.6 512 0 397.4 0 256C0 114.6 114.6 0 256 0C397.4 0 512 114.6 512 256zM99.5 144.8C77.15 176.1 64 214.5 64 256C64 362 149.1 448 256 448C297.5 448 335.9 434.9 367.2 412.5L99.5 144.8zM448 256C448 149.1 362 64 256 64C214.5 64 176.1 77.15 144.8 99.5L412.5 367.2C434.9 335.9 448 297.5 448 256V256z"></path></svg><!-- <i class="fas fa-ban"></i> Font Awesome fontawesome.com --></a></li>
    ...
    <script>
        ...
        window.addEventListener('swal:confirmmodal', event => {
            ...
            swalWithBootstrapButtons.fire({
                ...
                reverseButtons:  event.detail.reverseButtons,
            }).then((result) => {
                if (result.isConfirmed) {
                    window.livewire.emit('delete',event.detail.username);
                } else if (
        ...
        window.addEventListener('swal:suspendmodal', event => {
            const swalWithBootstrapButtons = Swal.mixin({
                customClass: {
                    confirmButton: 'btn btn-success m-1',
                    cancelButton: 'btn btn-danger m-2'
            ...
            swalWithBootstrapButtons.fire({
                ...
                if (result.isConfirmed) {
                    window.livewire.emit('suspend',event.detail.username);
                } else if (
                    /* Read more about handling dismissals below */
                    result.dismiss === Swal.DismissReason.cancel
                ) {
