                            ...
                            <form class="needs-validation" novalidate="">
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input class="form-control btn btn-primary" type="button" id="validationCustom05" value="Clear">
