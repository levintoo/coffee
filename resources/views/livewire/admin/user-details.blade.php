                    ...
                    <div class="row justify-content-center align-items-center">
                        <div class="col-sm-auto col-4">
                            <div class="avatar avatar-xl position-relative">
                                <img src="{{ asset('users') }}/{{ $user->photo_url }}" alt="" class="img-70 rounded-circle border-radius-lg shadow-sm">
                            </div>
                        </div>
...
{{--                                    <input class="form-control" type="email" placeholder="{{ Auth::user()->email }}"  wire:model="email">--}}
                            ...
                            <div class="col-6">
                                ...
                                <div class="input-group">
                                    <span class=" text-muted">{{ '+254'.$user->phone }}</span>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                ...
                                <div class="input-group">
                                    <span class=" text-muted">{{ $user->profession }}</span>
                        ...
                        <div class="row">
                            <div class="col-6 float-start mt-2">
                                <button class="btn btn-sm btn-outline-dark mb-0 mt-4"  wire:click.prevent="updateUser">Edit info</button>
                            </div>
                        </div>
                    </form>
                </div>
                ...
                <div class="card mt-4" id="delete">
                    <div class="card-header">
                        ...
                        <p class="text-sm mb-0">Once you suspend your account, there is no going back. Please be certain.</p>
                    </div>
                    <div class="card-body d-sm-flex pt-0">
                        <div class="d-flex align-items-center mb-sm-0 mb-4">
                            ...
                            <div class="ms-2">
                                ...
                                <span class="text-xs d-block">I want to suspend this account.</span>
                            </div>
                        </div>
                        <button class="btn btn-outline-danger mb-0 ms-auto" type="button" name="button">Suspend Account</button>
                    </div>
                </div>
            </div>
        </div>
